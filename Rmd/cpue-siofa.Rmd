---
title: "Annex 5:  Catch and Effort Analysis for Centroscymnus coelolepis"
...
```{r cpue}
# Aggregate CPUE over year/gear
cpue <- df %>% 
         group_by(Year,Gear,speciesScientificName) %>% 
...
## IEO dataset
Logbook data containing catches of Portugese dogfish
```{r data prep}
# Data preparation
