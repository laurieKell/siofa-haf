...
```{r figurename, echo=FALSE, out.width = '30%', fig.align="center"}
...
```{r}
source("~/pCloudDrive/projects/fao/VoI/R/fl_mcupd_fn.R")
```
...
# Data
```{r, data-fao}
load("/home/laurie/pCloudDrive/projects/mrag/siofa/data/inputs/fao_taxa.rda")
```

```{r, data-asfis}
asfis=read.csv("/home/laurie/pCloudDrive/projects/mrag/siofa/data/inputs/ASFIS_sp_2021.txt")
...
```{r, save-siofa}
save(siofa,file="../data/results/siofa.RData")
```
...
```{r, save-mrag}
save(mrag,file="../data/results/mrag.RData")
```

```{r, cor}
dat=cast(siofa,Genus+Species~trait,value="data") 

pr1=ggpairs(transform(dat[,c("Loo","K","Lm","G","M","r","h")],'l50:loo'=Lm/Loo)[c(1:3,7,8,4:6)])+
...
ggplot(subset(ssE,geartype=="trawlers")) +
    ...
    #geom_sf(data = iccat, fill = NA, col="red")+
    geom_sf(data = world) +
  theme_bw()+
